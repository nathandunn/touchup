...
import org.bbop.phylo.model.matrix.BasicCharacterStateMatrix;
import org.bbop.phylo.model.matrix.CharacterStateMatrix;
import org.bbop.phylo.model.matrix.CharacterStateMatrix.BinaryStates;
...
public class NexusBinaryStatesMatrixParser {
    ...
    public void parse() throws IOException {
        reset();
        final BufferedReader reader = ParserUtils.createReader( getNexusSource(), PhyloConstant.UTF_8 );
        String line;
