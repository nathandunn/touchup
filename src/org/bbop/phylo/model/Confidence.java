...
import org.bbop.phylo.io.PhylogenyData;
...
public class Confidence implements PhylogenyData, Comparable<Confidence> {
    ...
    public StringBuffer asSimpleText() {
        return new StringBuffer().append( PhyloUtil.FORMATTER_6.format( getValue() ) );
    }

    @Override
    public StringBuffer asText() {
        final StringBuffer sb = new StringBuffer();
        if ( !PhyloUtil.isEmpty( getType() ) ) {
            sb.append( "[" );
            sb.append( getType() );
            sb.append( "] " );
        }
        sb.append( PhyloUtil.FORMATTER_6.format( getValue() ) );
    ...
    public StringBuffer toNHX() {
        ...
        sb.append( FORMATTER.format( PhyloUtil.round( getValue(),
